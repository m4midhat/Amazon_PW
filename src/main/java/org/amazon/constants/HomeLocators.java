...
public class HomeLocators {
    public static final String hamburgerMenu = "[aria-label=\"Open Menu\"]";
    public static final String navigationMenuItems = "nav-a";
    public static final String searchTextBox = "twotabsearchtextbox";
